...
public class VideoController : MonoBehaviour
{
    ...
    void Update()
    {
        if (mVideoPlayer.isPlaying)
        {
            ...
            {
                if(mVideoPlayer.renderMode == UnityEngine.Video.VideoRenderMode.MaterialOverride)
                {
                    mVideoPlayer.Stop();
                }
                //mVideoPlayer.renderMode = UnityEngine.Video.VideoRenderMode.MaterialOverride;
            }
        }
        else
            ShowPlayButton(true);
    ...
    {
        mVideoPlayer.renderMode = UnityEngine.Video.VideoRenderMode.CameraNearPlane;
        if (mVideoPlayer.isPlaying)
        {
            ShowStopButton(true);
        }
    ...
    public void ShowStopButton(bool enable)
    {
        //StopButton.enabled = enable;
        //StopButton.GetComponent<Image>().enabled = enable;
